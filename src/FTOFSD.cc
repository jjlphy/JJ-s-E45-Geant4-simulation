...
FTOFSD::FTOFSD(const G4String& name)
...
//_____________________________________________________________________________
void
FTOFSD::Initialize(G4HCofThisEvent* HCTE)
{
  m_hits_collection = new G4THitsCollection<FTOFHit>(SensitiveDetectorName,
                                                     collectionName[0]);
...
//_____________________________________________________________________________
G4bool
FTOFSD::ProcessHits(G4Step* aStep, G4TouchableHistory* /* ROhist */)
{
  ...
  m_hits_collection->insert(new FTOFHit(SensitiveDetectorName, aStep));
...
//_____________________________________________________________________________
void
FTOFSD::EndOfEvent(G4HCofThisEvent* /* HCTE */)
{
}
