...
SDCSD::SDCSD(const G4String& name)
...
//_____________________________________________________________________________
void
SDCSD::Initialize(G4HCofThisEvent* HCTE)
{
  m_hits_collection = new G4THitsCollection<SDCHit>(SensitiveDetectorName,
                                                    collectionName[0]);
...
//_____________________________________________________________________________
G4bool
SDCSD::ProcessHits(G4Step* aStep, G4TouchableHistory* /* ROhist */)
{
  ...
  m_hits_collection->insert(new SDCHit(SensitiveDetectorName, aStep));
...
//_____________________________________________________________________________
void
SDCSD::EndOfEvent(G4HCofThisEvent* /* HCTE */)
{
}
