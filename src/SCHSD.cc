...
SCHSD::SCHSD(const G4String& name)
...
//_____________________________________________________________________________
void
SCHSD::Initialize(G4HCofThisEvent* HCTE)
{
  m_hits_collection = new G4THitsCollection<SCHHit>(SensitiveDetectorName,
                                                    collectionName[0]);
...
//_____________________________________________________________________________
G4bool
SCHSD::ProcessHits(G4Step* aStep, G4TouchableHistory* /* ROhist */)
{
  ...
  m_hits_collection->insert(new SCHHit(SensitiveDetectorName, aStep));
...
//_____________________________________________________________________________
void
SCHSD::EndOfEvent(G4HCofThisEvent* /* HCTE */)
{
}
