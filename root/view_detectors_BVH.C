...
void view_detectors_BVH() {
  ...
  TFile *f = TFile::Open("E45_segment_40.root","READ");
  ...
  TH2D *h_hit_bvh_d = new TH2D("h_hit_bvh_d", "BVH_D Hit Distribution;X [mm];Y [mm]", 400, 200, 500, 200, -150, 150);
  ...
  c->cd(3); h_hit_bvh_d->Draw("COLZ"); draw_bvh_d_overlay(350.0);// ★ BVH_D 중심 X = 350
