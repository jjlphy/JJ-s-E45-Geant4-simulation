// -*- C++ -*-
// Trigger_study_minusbeam_10_28_HTOFselect.C  (2025-10-29)
...
//   Trigger_study_minusbeam_10_28_HTOFselect("E45.root","g4hyptpc",
...
struct Counts {
  ...
  struct RC {
    ...
    // energy footprint
    double minSumE = 1e99;        // 생존 이벤트들의 타일 ΣEdep 중 최소값 (탐색용)
    double maxSumE = 0.0;
