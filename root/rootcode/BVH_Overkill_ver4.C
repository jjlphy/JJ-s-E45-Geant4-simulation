...
void ComputeOverkillFromOverlay(const char* data_root = "../E45_2pi_Ver4.root",
                                const char* overlay_txt = "overlay_triplets.txt",
...
void run_overkill() {
  ...
  const char* data_root   = "../E45_2pi_Ver4.root";
  const char* overlay_txt = "overlay_triplets.txt"; // BVH_3D_ver4 출력 복사해서 저장
